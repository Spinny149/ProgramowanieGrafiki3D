...
void SimpleShapeApplication::init() {
    ...
    GLuint i_buffer_handle, u_fragment_buffer_handle, v_buffer_handle, c_buffer_handle;
    ...
    V_ = lookAt(camera_position, camera_target, camera_up);
    const auto pvm = P_ * V_ * model;
